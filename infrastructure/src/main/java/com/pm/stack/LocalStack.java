...
public class LocalStack extends Stack {
    ...
    public LocalStack(final App scope, final String id, final StackProps props) {
        ...
        FargateService authService=createFargateService("AuthService","auth-service",List.of(4005),authServiceDB,Map.of("JWT_SECRET","JWT_SECRET=10a1e058e669c4b019ed175c8bed08b3e2ef0aa4d3d3fdee"));
    ...
    private CfnCluster createMskCluster(){
        return CfnCluster.Builder.create(this,"MskCluster").clusterName("Kafka-cluster").kafkaVersion("2.8.0").numberOfBrokerNodes(1).brokerNodeGroupInfo(CfnCluster.BrokerNodeGroupInfoProperty.builder()
    ...
    private FargateService createFargateService(String id, String imageName, List<Integer> ports, DatabaseInstance db, Map<String,String> additionalEnvVars){
        ...
        if(db!=null){
            ...
            envVars.put("SPRING_DATASOURCE_PASSWORD",db.getSecret().secretValueFromJson("12345").toString());
            envVars.put("SPRING_JPA_HIBERNATE_DDL_AUTO","update");
            envVars.put("SPRING_SQL_INIT_MODE","always");
            envVars.put("SPRING_DATASOURCE_KIKARI_INITIALIZATION_FAIL_TIMEOUT","60000");
        }
    ...
    public static void main(String[] args) {
        ...
        app.synth();
        System.out.println("App systhesizing in progress....");
    }
}
